...
# Try to import speech recognition components
try:
...
class SecureChatbotApplication:
    ...
    def initialize_components(self):
        ...
        try:
            ...
            # Initialize speech recognition if enabled and available
    ...
    def start(self):
        ...
        try:
            ...
            # Set up speech recognition routes if enabled and available
